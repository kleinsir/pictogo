...
export default function CompressTo500kbPage() { return <LongTailToolPage titleKey="page.compressTo500kbTitle" descriptionKey="page.compressTo500kbDesc" detailKey="page.compressTo500kbDetail" faq="compressTo500kb" initial="compress" defaultCompressionMode="target" defaultTargetSizeKb={500}/>; }
