...
export default function CompressTo1mbPage() { return <LongTailToolPage titleKey="page.compressTo1mbTitle" descriptionKey="page.compressTo1mbDesc" detailKey="page.compressTo1mbDetail" faq="compressTo1mb" initial="compress" defaultCompressionMode="target" defaultTargetSizeKb={1024}/>; }
